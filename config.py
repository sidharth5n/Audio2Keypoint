...
def create_parser(parser):
    ...
    parser.add_argument('-lms', '--lambda_enc', type=float, default=1, help='multiplier for struct loss')
    ...
    parser.add_argument('-tc', '--train_csv', type=str, default='./Gestures/train.csv')
